...
```
Historical Dataset (model_ready.parquet)
        │
        ▼
Feature Engineering Pipeline
        │
        ▼
Impact Engine (CatBoost Regressor)
        │
        ▼
Impact Score (0-100)
        │
...
Risk Class (Low / Medium / High / Critical)
        ...
        ├────────────────────┐
        ▼                    ▼
Resource Engine        Historical Intelligence
        │                    │
        ▼                    ▼
Resource Timeline      Similar Incidents
Estimated Resolution   Corridor DNA
                       Confidence Level
                       Risk Window
                       Transit Chain Flag
        │                    │
